...
>
> In C and C++, two different operators are used to access members: you use . when
> working with an object directly, and -> when working with a pointer to the
> object and need to dereference it first. In C++, these operators can be used
> to call methods; in C, they are only used to access struct fields.
...
> called automatic referencing and dereferencing. Calling methods is one of the few places
> in Rust with this behavior.
>
